...
class QNNBag(Model):
    ...
    def __init__(self, nqubits, backend, ansatz, embedding, n_class, layers, epochs, max_samples, max_features, n_features, n_estimators, shots, max_bond_dim=64, lr=0.01, batch_size=50, seed=1234) -> None:
        super().__init__()
        ...
        device_kwargs_mps_cpu = {
            "max_bond_dim": max_bond_dim,
            "cutoff": np.finfo(np.complex128).eps,
            "contract": "auto-mps",
        }
        device_kwargs_mps_gpu = {
            "max_bond_dim": max_bond_dim,
            "cutoff": 1e-10,
            "cutoff_mode": "abs",
        }
