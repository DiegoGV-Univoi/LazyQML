...
class QNNBag(Model):
    ...
    def __init__(self, nqubits, ansatz, embedding, n_class, layers, epochs, max_samples, n_samples, max_features, n_features, n_estimators, lr=0.01, batch_size=50) -> None:
        super().__init__()
